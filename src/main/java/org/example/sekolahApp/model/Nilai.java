...
public class Nilai {
    ...
    public Nilai(int nilaiId, int siswaKelasId, int mapelId, String jenisUjian, int nilai) {
        ...
        this.studentSubjectId = new SimpleIntegerProperty(0);
        this.grade = new SimpleDoubleProperty(nilai);
    ...
    // --- KONSTRUKTOR BARU YANG ANDA BUTUHKAN ---
    /**
     * Konstruktor sederhana untuk membuat objek Nilai baru dari UI,
     * yang belum memiliki nilai_id. Ini akan memperbaiki error di InputNilaiController.
     */
    public Nilai(int siswaKelasId, int mapelId, String jenisUjian, int nilai) {
        this.gradeId = new SimpleIntegerProperty(0); // ID 0 menandakan ini objek baru
        this.studentSubjectId = new SimpleIntegerProperty(0);
        this.grade = new SimpleDoubleProperty(nilai);
        this.assessmentType = new SimpleStringProperty(jenisUjian != null ? jenisUjian : "");
        this.assessmentDate = null;
        ...
        // Mengisi legacy fields yang relevan
        this.siswaKelasId = new SimpleIntegerProperty(siswaKelasId);
        this.mapelId = new SimpleIntegerProperty(mapelId);
    }

    // --- SISA KODE BIARKAN SEPERTI SEMULA ---
